        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="part">
                ...
                <div class="form-group">
                    ...
                    <input id="upload-thumbnail" name="img" type="file" class="file" data-show-preview="false" data-show-upload="false" data-show-remove="false" placeholder="Choose a file" required>
