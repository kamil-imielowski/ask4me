...
<div class="section purchases gifts animated fadeIn">
    <h4 class="dashboard-heading">Gifts</h4>
    
    <div class="part">
        <h6><?php echo $translate->getString("receivedGifts"); ?></h6>
        <p><?php echo empty($gifts_received->getGifts()) ? $translate->getString("dontHaveReceivedGifts") : ''; ?></p>
    ...
    <div class="part">
        ...
        <p><?php echo empty($gifts_sent->getGifts()) ? $translate->getString("dontHaveSentGifts") : ''; ?></p>
