    ...
    <div class="form">
        ...
        <form method="post">
            ...
            <div class="part">
                ...
                <span><i class="fa fa-calendar"></i><span><?php echo $withdrawal->getDateCreated()->format("d.m.Y"); ?></span></span><!--<a href="#" onClick="tab('transactions', this);"><span>check all transactions</span></a>-->
            </div>
            ...
            <div class="part">
                ...
                <div class="bank"><!--widoczne tylko przy wyborze bank transfer-->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="iban" placeholder="<?php echo $translate->getString("bankAccountNumber") ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="owner_name" placeholder="<?php echo $translate->getString("accountOwnerName") ?>">
                    </div>
                    <div class="form-group">
                        <label><?php echo $translate->getString("accountOwnerLastName") ?>:</label>
                        <input type="text" name="owner_last_name" placeholder="<?php echo $translate->getString("accountOwnerLastName") ?>">
                    </div>
                </div>
                <!--
                <div class="paypal">
