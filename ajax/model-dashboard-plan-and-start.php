                ...
                <div id="publicPlanTab">
                    ...
                    <div class="part" id=""><!--tylko dla public webcam broadcast-->
                        <div class="form-group">
                            ...
                            <div class="select">
                                <select required name="public[activity][]" oninvalid="this.setCustomValidity(`<?php echo $translate->getString("validStartActPriceTab") ?>`)">
                                    ...
                                    <?php }?>
                                    <?php if(!empty($user->getActivityPrices()->getPublicDoSTH())){?>
