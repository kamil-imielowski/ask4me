const GO_BUTTON_START = "Start transmisji";
...
var wsURL = "wss://59d1dcdf890ea.streamlock.net/webrtc-session.json";
...
function pageReady()
{
    var cookieWSURL = "wss://59d1dcdf890ea.streamlock.net/webrtc-session.json";
