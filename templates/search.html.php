    ...
    <div class="container section">
        ...
        <div id="content" class="store-data">
            <div class="homepage animated fadeIn">
                <p><?php if(empty($standardUsers) && empty($modelUsers) && empty($blogs) && empty($products)){echo $translate->getString("noResult");} ?></p>
                            ...
                            <?php foreach($standardUsers as $userFind): ?>
                                    ...
                                    <div class="profile">
                                        <div class="box">
                                            ...
                                            <div class="icons">
                                                <a h-ref="#" class="med-prim-bg white-txt message" login="<?php echo $userFind->getLogin() ?>"><i class='material-icons'>mail_outline</i></a>
