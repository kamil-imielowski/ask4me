        ...
        <div class="container">
            ...
            <div class="wrapper">
                <div class="box center white-txt">
                    <h4><?php echo $translate->getString("realEscortGirls") ?></h4>
                    ...
                    <a href="/escort/" class="button med-prim-bg"><?php echo $translate->getString("borwseEscortGirl") ?></a>
                </div>
                <div class="box center white-txt">
                    <h4><?php echo $translate->getString("virtualCamModels") ?></h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    <div class="flex flex-icons">
                        <div class="icon">
                    ...
                    <a href="/live-cams/" class="button med-prim-bg"><?php echo $translate->getString("browseCamModels") ?></a>
                </div>
            </div>
        </div>
    </div>
...
function drawVisualization() {var data = new google.visualization.DataTable();
    ...
    <?php foreach($countriesForMap as $i => $country){ ?>
        ...
        i = <?php echo $i; ?>;
        data.addRows([[{v:country,f:'Click to search'},i,'']]);
        ivalue[country] = 'escort.php?action=addCountryToFilters&country='+country;
    <?php }?>
