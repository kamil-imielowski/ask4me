                ...
                <div class="box activity">
                    ...
                    <div class="inside">
                        ...
                        <div id="currentActivityContainer">
                            <?php if(!is_null($transmission->getCurrentActivity()) && $transmission->getCurrentActivity()->getType() == 1): ?>
                            ...
                            <?php elseif(!is_null($transmission->getCurrentActivity()) && $transmission->getCurrentActivity()->getType() == 2): ?>
                            ...
                            <?php else: ?>
                               <?php echo $translate->getString("currentActivitynotSelected"); ?>
                            <?php endif ?>
                        </div>
                    </div>     
                </div>
